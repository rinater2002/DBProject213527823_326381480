...
values (6, 31, 2000, 809);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
values (9, 13, 2001, 834);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
values (1, 10, 2002, 817);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
values (3, 49, 2003, 822);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
values (6, 29, 2004, 845);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
...
values (3, 7, 2008, 834);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
values (4, 12, 2009, 844);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
values (5, 28, 2010, 837);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
values (4, 26, 2011, 840);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
values (9, 46, 2012, 847);
insert into INVENTORY (shelf, unitsinstock, inventoryid, catalognumber)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 8466, 'gi7BAUJU@gmail.com', 531149208, 'Morning', 3, 'Jackson Murphy');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 15785, 'oiTZv76k@gmail.com', 571796738, 'Morning', 6, 'Claire Miller');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 11307, 'x4XJknNp@gmail.com', 572740432, 'Morning', 9, 'Amelia Campbell');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14112, 'EsdgtOYs@gmail.com', 576945371, 'Morning', 10, 'Sophia King');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 11800, 'A9qO1tjN@gmail.com', 595522957, 'Morning', 13, 'Henry Lopez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 9470, 'TgXQrIAR@gmail.com', 552337692, 'Morning', 16, 'Sophia Anderson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 14003, 'PQrlU0DH@gmail.com', 503386039, 'Morning', 22, 'Avery Davis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12296, 'V463Osef@gmail.com', 582066880, 'Morning', 31, 'Liam Young');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 15082, 'TwnwCmkt@gmail.com', 542467998, 'Morning', 35, 'Mason Miller');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 10240, 'yrybonQD@gmail.com', 576716252, 'Morning', 36, 'Abigail Walker');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14276, 'jP8RHiOr@gmail.com', 562485543, 'Morning', 37, 'Elizabeth Scott');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 15270, 'fr07YdqE@gmail.com', 538306078, 'Morning', 45, 'Camila Young');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 15577, 'R7tQK1Sr@gmail.com', 526704387, 'Morning', 46, 'Mateo Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 13351, 'dgz3BOmZ@gmail.com', 518269520, 'Afternoon', 47, 'Alexander Mitchell');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 11868, 'j4CbgqnF@gmail.com', 558056698, 'Morning', 48, 'Henry Scott');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 14772, 'moQMLCBt@gmail.com', 599394146, 'Afternoon', 49, 'Lucas Wright');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 10828, '2hBAWI0n@gmail.com', 554253415, 'Morning', 50, 'Mason Diaz');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 10063, 'BX18EyNn@gmail.com', 509320960, 'Morning', 51, 'Harper Clark');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 10259, 'LBEDM70b@gmail.com', 589856059, 'Morning', 54, 'Charlotte Allen');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 12793, 'yo7rv2m3@gmail.com', 560529370, 'Morning', 55, 'Mia Martin');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 9532, 'ZQzzg1z8@gmail.com', 514869393, 'Morning', 58, 'Charlotte Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 11913, 'z2VMinVL@gmail.com', 556545258, 'Morning', 63, 'Michael Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 11594, 'zsGxd509@gmail.com', 518611303, 'Morning', 69, 'Charlotte Hall');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 11562, 'PdtASed0@gmail.com', 593795124, 'Morning', 70, 'Sofia Wright');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 14664, 'gMhuzYc0@gmail.com', 505817467, 'Morning', 71, 'Noah Rodriguez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 15976, 'UVWpEaTp@gmail.com', 579430329, 'Morning', 74, 'Evelyn Wright');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 14174, 'AzIy1pPl@gmail.com', 559027760, 'Morning', 77, 'Elias Gonzalez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 8059, '3lBcPXTY@gmail.com', 558713988, 'Evening', 78, 'James Wood');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 13421, 'tEXa18Z0@gmail.com', 565641120, 'Morning', 79, 'Mason Walker');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 8856, 'YnbzsL8k@gmail.com', 514677999, 'Morning', 80, 'Lucas Green');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 11018, '6vuL1i45@gmail.com', 592891900, 'Morning', 81, 'Camila Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 15040, 'iiA9miYG@gmail.com', 590019845, 'Morning', 84, 'Liam Davis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 9869, 'huBX75Wh@gmail.com', 513678912, 'Morning', 85, 'Evelyn Diaz');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 15210, 'IliqJvrF@gmail.com', 520689705, 'Morning', 98, 'Sophia Scott');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 9584, 'vN40wQJS@gmail.com', 592974002, 'Morning', 99, 'Zoe King');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 15711, 'vYFi1BNC@gmail.com', 586450881, 'Morning', 100, 'Mason Thomas');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 13863, 'OeJNOmXf@gmail.com', 524097816, 'Morning', 104, 'Sophia Harris');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 15499, 'TYgdOxLE@gmail.com', 548989383, 'Morning', 108, 'Ethan Harris');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 12082, 'qfwMbMps@gmail.com', 518829946, 'Morning', 111, 'Evelyn Roberts');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 14597, 'srcIaymu@gmail.com', 531311411, 'Morning', 119, 'Claire Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 10709, 'bhMGH8Ps@gmail.com', 546038928, 'Morning', 120, 'Ethan Jackson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 10436, 'AZFIAUPh@gmail.com', 586384716, 'Morning', 125, 'Ethan Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14831, 'tgyP87nU@gmail.com', 566625064, 'Morning', 126, 'Mason Johnson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 14651, 'cZbJD4ZV@gmail.com', 541758860, 'Morning', 127, 'Harper Allen');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 13791, '8DI1thph@gmail.com', 505065140, 'Morning', 128, 'Scarlett Allen');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 13783, 'IEK1LKdt@gmail.com', 596851087, 'Evening', 129, 'Lucas Campbell');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 14575, 'ivjD1J4C@gmail.com', 589054493, 'Morning', 130, 'Ella Thomas');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12889, 'VlsjjorT@gmail.com', 595616828, 'Morning', 131, 'Emma Hernandez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12452, 'ucGpH8gv@gmail.com', 544503063, 'Morning', 134, 'Matthew Davis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 7850, 'agKPJ3wb@gmail.com', 542738027, 'Afternoon', 135, 'Ethan Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12330, 'nHwPrbmO@gmail.com', 584238863, 'Morning', 136, 'Logan Allen');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 13651, 'EFUAeDcN@gmail.com', 548756040, 'Morning', 143, 'Alexander Miller');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14632, 'sDXsGKz7@gmail.com', 586233230, 'Morning', 144, 'Mason King');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 8613, 'I7HPYKIv@gmail.com', 560352029, 'Afternoon', 145, 'Ethan Hall');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 15107, 'pML4bvqf@gmail.com', 565054766, 'Morning', 146, 'Elias Carter');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 15859, 'LaPkhLQz@gmail.com', 575258169, 'Morning', 149, 'Mason Clark');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 14952, 'Wk1Ilwzs@gmail.com', 597121496, 'Morning', 154, 'Emma Turner');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 13822, 'F5GvjfaO@gmail.com', 594766367, 'Morning', 155, 'Liam Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 15233, '09bBLCcP@gmail.com', 562694889, 'Morning', 158, 'Mason Lee');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 10780, '0V5RCVD8@gmail.com', 577044786, 'Afternoon', 159, 'Avah Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 8817, 'CQyYvjmI@gmail.com', 523297388, 'Morning', 160, 'Abigail Young');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 16192, 'aoleN6Vt@gmail.com', 509334722, 'Morning', 161, 'William Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 8415, 'EV2GPBGD@gmail.com', 563189422, 'Morning', 172, 'Jackson Diaz');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 12444, 'fRfEc48B@gmail.com', 591574501, 'Evening', 173, 'Henry Davis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12667, 'fB3pXp5X@gmail.com', 510343881, 'Morning', 174, 'Emma Clark');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 13257, 'qLuHEmxt@gmail.com', 575352411, 'Morning', 180, 'David Allen');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 14319, 'Du7es9Vi@gmail.com', 560462040, 'Morning', 183, 'Liam Roberts');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 15634, 'epsYzeoF@gmail.com', 533303640, 'Morning', 187, 'Noah Garcia');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 14958, 'cq9RuSZY@gmail.com', 590571518, 'Morning', 188, 'Mason Williams');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 12204, 'JOILxHhW@gmail.com', 516385582, 'Afternoon', 189, 'Lucas Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 15219, 'fPmwCbFX@gmail.com', 558461953, 'Morning', 190, 'Mia Garcia');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 9566, 'oyCZpce5@gmail.com', 528718737, 'Morning', 191, 'Emma Clark');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 10989, 'SIItpMkl@gmail.com', 561817795, 'Morning', 195, 'Logan Harris');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 8887, '2V7QmuiF@gmail.com', 534931109, 'Morning', 196, 'Ava Miller');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 12395, 'El96HfMS@gmail.com', 500409706, 'Morning', 197, 'Sofia Lewis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 7736, 'oxYWZ70x@gmail.com', 531691969, 'Evening', 198, 'Violet Miller');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 12344, 'ncYwERq3@gmail.com', 553931039, 'Morning', 199, 'Lucas Williams');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 9494, 'rpKkYKgY@gmail.com', 562634725, 'Morning', 200, 'Logan Gonzalez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 14054, 'jPqXIQLE@gmail.com', 526015865, 'Morning', 203, 'Camila Thomas');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 10832, 'aLVYLpGc@gmail.com', 525483933, 'Morning', 212, 'Emily Lee');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 10212, 'dAraXMZi@gmail.com', 528757463, 'Morning', 213, 'Emily Baker');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 11263, 'pl7oRCHj@gmail.com', 591132607, 'Evening', 214, 'Charlotte Hernandez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 12382, '7ipiuIGo@gmail.com', 529988373, 'Morning', 215, 'Ava Roberts');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 10188, 'ulG9z5kA@gmail.com', 532130221, 'Evening', 216, 'Ava Harris');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 8777, 'WH8peg4h@gmail.com', 541159511, 'Morning', 217, 'Ella Hall');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 7552, '6mmev0SD@gmail.com', 574913325, 'Evening', 218, 'Amelia King');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 15324, 'qPK7uXjo@gmail.com', 594141307, 'Morning', 219, 'Elias Clark');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14787, 'z14fOBcW@gmail.com', 525309009, 'Morning', 223, 'Noah Scott');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 13648, 'NU7sEQIj@gmail.com', 510126263, 'Afternoon', 224, 'Henry Lopez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 10351, 'OlpBc5Xe@gmail.com', 536192517, 'Morning', 225, 'Harper Young');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14381, 'lXG8nerh@gmail.com', 548228870, 'Morning', 226, 'Ethan Lewis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 9478, 'ErJowWVj@gmail.com', 555868937, 'Morning', 231, 'Evelyn Hernandez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 11543, '4ic3eaE7@gmail.com', 511668852, 'Morning', 232, 'Liam Hall');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 13465, 'kZZ5j66z@gmail.com', 554897172, 'Morning', 235, 'Zoe Young');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 8908, 'OWzpY2V1@gmail.com', 506705567, 'Morning', 244, 'Ethan Garcia');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12893, 'sNsdC7sc@gmail.com', 589537870, 'Morning', 250, 'Logan Allen');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 7576, 'F3ivUYE2@gmail.com', 547593159, 'Evening', 251, 'Evelyn Wilson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 11007, '7wLDHASG@gmail.com', 540415830, 'Morning', 252, 'Alexander Wright');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 13805, 'X1bCvrA0@gmail.com', 577713103, 'Morning', 255, 'Evelyn Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14501, '1MZi0zES@gmail.com', 572292450, 'Morning', 256, 'Mason Nelson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 13122, 'wjayEG9a@gmail.com', 542436459, 'Morning', 257, 'Ava Garcia');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 8285, '5YM23Phy@gmail.com', 566109080, 'Afternoon', 258, 'Ava Smith');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 9540, '7fysTn9q@gmail.com', 569388320, 'Morning', 259, 'Noah Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 15741, 'n0GNo1C5@gmail.com', 591147522, 'Morning', 263, 'Mateo Scott');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12651, '7oshZjvY@gmail.com', 557662005, 'Afternoon', 264, 'Noah Adams');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 11531, 'i4p5S5ph@gmail.com', 586488440, 'Morning', 265, 'Ethan Young');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 12167, 'VWQ7pIvC@gmail.com', 546026199, 'Afternoon', 266, 'Logan Wood');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 14427, 'FMtVD4mL@gmail.com', 533068166, 'Morning', 267, 'Oliver Anderson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 15686, 'pJkHXxo7@gmail.com', 575733860, 'Morning', 268, 'Mason Lewis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 12673, 'Pwbtidb5@gmail.com', 532540716, 'Morning', 269, 'Aaliyah Scott');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 15464, 'zNgTfUJB@gmail.com', 511838668, 'Morning', 270, 'Scarlett Williams');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 11816, 'zugoH8YT@gmail.com', 598230508, 'Afternoon', 271, 'Elijah Walker');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 9247, '3v7yUitg@gmail.com', 536387642, 'Morning', 272, 'Isabella Davis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 12117, 'y3fARtvX@gmail.com', 548006453, 'Morning', 273, 'Elijah Diaz');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 10121, '4oVEzN7D@gmail.com', 584091607, 'Morning', 276, 'Harper Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 10534, '73CNXgLe@gmail.com', 573579439, 'Afternoon', 277, 'Elijah Turner');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 10241, 'e088K4ub@gmail.com', 554122833, 'Morning', 278, 'Aurora Jones');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 8819, 'e2HoJDXL@gmail.com', 590104781, 'Afternoon', 279, 'Mason Carter');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 11168, 'gSCJQDC9@gmail.com', 595217872, 'Morning', 280, 'Abigail Nelson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 13969, 'BUl9qC0N@gmail.com', 567653563, 'Morning', 281, 'Evelyn Rodriguez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12779, 'qKTjenvZ@gmail.com', 594965585, 'Morning', 287, 'Mason Murphy');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 13715, 'J8ygK8VI@gmail.com', 575459032, 'Morning', 292, 'Jackson Miller');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 8903, 'UAUagf14@gmail.com', 534419887, 'Morning', 295, 'Liam Thomas');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 13937, 'ZYwRHByt@gmail.com', 538598018, 'Morning', 298, 'Amelia Miller');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 14122, 'XXrYMfLK@gmail.com', 556321193, 'Morning', 305, 'Charlotte Diaz');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 13358, 'glyekcR9@gmail.com', 593438995, 'Morning', 308, 'Zoe Young');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 11777, 'ltHjHuun@gmail.com', 590862113, 'Morning', 312, 'Mia Lee');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12712, 'dLlGdODf@gmail.com', 591467756, 'Morning', 313, 'Mason Mitchell');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 8363, 'mOwFDV6g@gmail.com', 513199101, 'Evening', 314, 'Noah Hall');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 8934, 'A4nGnp1S@gmail.com', 516364296, 'Morning', 315, 'Harper Carter');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 14594, 'SEerS3Rr@gmail.com', 567924958, 'Morning', 316, 'Amelia Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 10580, '5EFoqgKz@gmail.com', 596620804, 'Morning', 317, 'Amelia Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 12077, 'jEHxNwk0@gmail.com', 569587843, 'Morning', 320, 'Evelyn Rodriguez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 16336, 'O6fYRwF1@gmail.com', 528031003, 'Morning', 324, 'Elijah Harris');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 10739, 'gkqMbxdr@gmail.com', 507155069, 'Afternoon', 325, 'Noah Diaz');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 12639, 'IPPTfI7v@gmail.com', 525547330, 'Morning', 326, 'Violet Walker');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 15579, '5JesFpQ2@gmail.com', 523023839, 'Morning', 329, 'Avery Jones');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 9125, 'ONLZCxI9@gmail.com', 569256757, 'Morning', 332, 'Luna Phillips');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 7578, 'm5wWgZNn@gmail.com', 588967892, 'Afternoon', 333, 'James Wright');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14386, 'L5a1AmxO@gmail.com', 529437123, 'Morning', 334, 'Mateo Harris');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 9275, '24OsitCY@gmail.com', 524796363, 'Morning', 335, 'Avah Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 8360, 'u43EI0Kt@gmail.com', 569442839, 'Morning', 338, 'Charlotte Garcia');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 14828, 'hYjJRn1E@gmail.com', 512881514, 'Morning', 342, 'Charlotte Lewis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 13951, 'aTTT9QVf@gmail.com', 535597591, 'Morning', 343, 'Elijah Allen');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 12210, 'B8ojr5PU@gmail.com', 592310757, 'Morning', 346, 'Harper Bell');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 9693, 'aTFmk2Vr@gmail.com', 506916652, 'Morning', 358, 'Sofia Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 8256, 'YUXxDp8p@gmail.com', 532665232, 'Morning', 359, 'Abigail Rodriguez');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 9842, 'JlaFoxfF@gmail.com', 588426256, 'Morning', 360, 'Elijah Clark');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 8424, '7xZUUbNR@gmail.com', 540463916, 'Morning', 366, 'Camila Walker');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12425, 'u89Cfmd8@gmail.com', 504254558, 'Morning', 367, 'Sofia Thomas');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 13309, 'L81Gkmp1@gmail.com', 501019696, 'Afternoon', 368, 'Emily Johnson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 15453, '70cbwBca@gmail.com', 515042721, 'Morning', 369, 'Benjamin Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 15065, 'WGSqXsO2@gmail.com', 500046415, 'Morning', 370, 'Ava Davis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 16070, 'QOSvrh1r@gmail.com', 502776679, 'Morning', 371, 'Sophia Nelson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 10001, 'lDx57p3s@gmail.com', 511729022, 'Morning', 374, 'Julian Pierce');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 12095, 'g5Hx7qCv@gmail.com', 596598587, 'Morning', 375, 'Evelyn Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 8866, 'Ac40NdiY@gmail.com', 536280685, 'Morning', 378, 'Harper Wright');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 14709, 'oUGgwero@gmail.com', 593240846, 'Evening', 382, 'Logan Davis');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Prepress Technician', 9678, 'gzcqytz9@gmail.com', 591195411, 'Afternoon', 391, 'Evelyn Cruz');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 9261, '4gAOCGvY@gmail.com', 520820659, 'Morning', 392, 'Harper Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
...
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Customer Service Representative', 12118, '0wjVxlQp@gmail.com', 504583403, 'Morning', 395, 'Luna Robinson');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values (' Graphic Designer', 9458, 'HxKvLbhu@gmail.com', 583027794, 'Afternoon', 396, 'Noah Moore');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 9357, 'VZ66xbGU@gmail.com', 553864574, 'Morning', 397, 'Olivia Clark');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
values ('Press Operator', 12788, '4BVRYEYO@gmail.com', 588097735, 'Morning', 398, 'Stella Thomas');
insert into WORKERS (workersrole, wage, workersmail, workersphone, shift, idwo, workersname)
